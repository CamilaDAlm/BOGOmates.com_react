   ...
   return(
        ...
        <div className="w3-content" style={{maxWidth:"2700px"}}>
            <h5 className="w3-center w3-padding-64">
              <span className="w3-tag w3-wide" style={{backgroundColor:"rgba(144, 101, 241)"}}>WELCOME</span>
              </h5>
        ...
        <div className="w3-content" style={{maxWidth:"2700px"}}>
            <h5 className="w3-center w3-padding-64"><span className="w3-tag w3-wide"style={{backgroundColor:"rgba(144, 101, 241)"}}>
              PROMOS</span></h5>
        ...
        <div class="w3-container" id="register" style={{paddingBottom:"32px"}}>
      <div class="w3-content" style={{maxWidth:"700px"}}>
        <h5 class="w3-center w3-padding-48"><span class="w3-tag w3-wide" style={{backgroundColor:"rgba(144, 101, 241)"}}>
          REGISTER</span></h5>
        ...
        <span class="w3-tag"style={{backgroundColor:"rgba(144, 101, 241)"}}>REGISTER NOW!</span> 
