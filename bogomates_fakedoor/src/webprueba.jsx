...
return(
 ...
 <header className="bgimg w3-display-container w3-grayscale-min" id="home">
    ...
    <div class="w3-container" id="about">
      <div class="w3-content" style={{"max-width":"2700px"}}>
        ...
        <img src={"https://www.w3schools.com/w3images/coffeeshop.jpg"} style={{"width":"100%","max-width":"1000px"}} className="w3-margin-top"/>
